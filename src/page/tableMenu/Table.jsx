...
const TableRestaunent = () => {
  ...
  const photos = [
    `http://placeandalosia.free.nf/images/${state.elm.img1}.jpg`,
    `http://placeandalosia.free.nf/images/${state.elm.img2}.jpg`,
    `http://placeandalosia.free.nf/images/${state.elm.img3}.jpg`,
    `http://placeandalosia.free.nf/images/${state.elm.img4}.jpg`,
    `http://placeandalosia.free.nf/images/${state.elm.img5}.jpg`,
    `http://placeandalosia.free.nf/images/${state.elm.img6}.jpg`,
  ];
