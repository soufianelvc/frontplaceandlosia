...
// //   const photos = [
// //       `http://localhost:8000/images/${state.elm.img1}`
// //     ,`http://localhost:8000/images/${state.elm.img2}`
// //     ,`http://localhost:8000/images/${state.elm.img3}`
// //     ,`http://localhost:8000/images/${state.elm.img4}`
// //     ,`http://localhost:8000/images/${state.elm.img5}`
// //     ,`http://localhost:8000/images/${state.elm.img6}`,
// //   ];
...
// // useEffect(() => {
// //   // console.log(cid);
// //   dispatch(getAllCommentairesRoom(state.elm.id));
...
// //    dispatch(addReservation({"clientId":user.id,"roomNumber":state.elm.id,
// //   "startDate":formattedStartDate,"endDate":formattedEndDate}));
// //   setOpenAlert(false);
// //   navigate('/reservationsClient')
// // }

// // const allcmt = useSelector(state => state.allCommentairesRoom.CommentairesRoom);
// // console.log(allcmt)
// // ///customAlert 
...
// //             <ReteContainer cmt={allcmt} chambre_id={state.elm.id} chambre={state.elm} dd={state}/>
// //       <MailList />
...
// // const allcmt = useSelector(state => state.allCommentairesTable.CommentairesRoom);
// // console.log(allcmt)
// // ///customAlert 
// // const [openAlert, setOpenAlert] = useState(false);
// // const handleCloseAlert = () => {
