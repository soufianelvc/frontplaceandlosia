...
//   return (
//     <div className="cardd">
//       <img src={`http://placeandalosia.free.nf/images/${data.image}`} alt="" className="product--image " style={{height:"150px"}} />
...
const Product = ({ data }) => {
  ...
  return (
    <div className='product-card'>
      <img src={`http://placeandalosia.free.nf/images/${data.image}`} alt='' className='product-image' />
