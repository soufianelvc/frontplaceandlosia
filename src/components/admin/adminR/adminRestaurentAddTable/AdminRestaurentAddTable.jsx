...
// import './AdminRestaurentAddTable.css'; // Update the CSS file as needed
...
//       const res = await axiosClient.post("http://localhost:8000/api/tables", formData, {
//         headers: {
//           'Content-Type': 'multipart/form-data',
//         },
//       });
//       console.log(res);
//     await  navigate('/management_tables');
//     } catch (error) {
...
//             <input type="text" className="input-form-table d-block mt-3 px-3" name="types" placeholder="Type" value={types} onChange={(e) => setTypes(e.target.value)} />
//             <input type="text" className="input-form-table d-block mt-3 px-3" name="titleT" placeholder="Title" value={titleT} onChange={(e) => setTitleT(e.target.value)} />
//             <textarea className="input-form-table-area p-2 mt-3" rows="4" cols="50" name="detailsT1" placeholder="Description 1" value={detailsT1} onChange={(e) => setDetailsT1(e.target.value)} />
//             <input type="number" className="input-form-table d-block mt-3 px-3" name="rating" placeholder="Rating" value={rating} onChange={(e) => setRating(e.target.value)} />
//             <select name="hotelId" className="selectt input-form-table-area d-block mt-3 px-5" value={hotelId} onChange={(e) => setHotelId(e.target.value)}>
//               <option value="1">Fes</option>
//               <option value="2">Casa</option>
//               <option value="3">Marakech</option>
//             </select>

//             <textarea className="input-form-table-area p-2 mt-3" rows="4" cols="50" name="detailsT2" placeholder="Description 2" value={detailsT2} onChange={(e) => setDetailsT2(e.target.value)} />

//             <div className="d-flex justify-content-between mt-2">
//               <input type="number" className="input-form-table px-1 mx-1" name="numberAdult" placeholder="Number Adult" value={numberAdult} onChange={(e) => setNumberAdult(e.target.value)} />
//               <input type="number" className="input-form-table px-1 mx-1" name="numberChildren" placeholder="Number Children" value={numberChildren} onChange={(e) => setNumberChildren(e.target.value)} />
//             </div>

//             <textarea className="input-form-table-area p-2 mt-3" rows="4" cols="50" name="detailsT3" placeholder="Description 3" value={detailsT3} onChange={(e) => setDetailsT3(e.target.value)} />
...
//                               <div className="card">
//                                 <img src={image['data_url']} alt="" className="card-img-top" style={{ width: '100%', height: '100px', objectFit: 'cover' }} />
//                                 <div className="card-body">
//                                   <button
...
//               </div>
//             </div>
//             <button type="submit" className="btn-save-table d-inline mt-2">Save Modifications</button>
//           </form>
//         </div>
//       </div>
//     </div>
